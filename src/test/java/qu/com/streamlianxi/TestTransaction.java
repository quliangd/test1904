...
public class TestTransaction {
	...
	public void test3(){
		transactions.stream()
				...
				.map(Transaction::getTrader)//映射之后已经是交易员了
	...
	public void test4(){
		...
		transactions.stream()
				.map(s -> s.getTrader().getName())
				.sorted()
				.flatMap(TestTransaction::filterAarray)
				.sorted(Comparator.comparing(s->s.compareToIgnoreCase(s)))
				.forEach(System.out::print);
	}

	public static Stream<String> filterAarray(String str){
	...
	public void test7(){
		...
		System.out.println("op1.get().getValue() = " + op1.get().getValue());
